function [errorl,time,mu_x_est,gammare,H_re] = kroSBL1pi(noise_var,Res1,numItr,H,H_p1,H_p2,A1,A2,y,K2,irs_pattern,A_irs_a,A_irs_d,H1,H2,SNR,thres,overheadi)
...
while(itr1 < numItr + 1 && norm1 > thres) % do the iteration
    ...
    [gamma1,mat1v,mat1r] = power_iteration(mat1');
    mat2 = reshape(abs(mat1v*mat1r),l3,l2);
    [gamma2,mat2v,gamma3] = power_iteration(mat2');
    gamma3 = abs(mat2v*gamma3);
